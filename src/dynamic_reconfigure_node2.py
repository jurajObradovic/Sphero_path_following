...
from sphero_path_following.cfg import Reynolds2Config
...
class DynReconf():
    ...
    def __init__(self):
        ...
        Server(Reynolds2Config, self.callback)
...
if __name__ == "__main__":
    ...
    rospy.init_node("dyn_reconf2", anonymous=False)
