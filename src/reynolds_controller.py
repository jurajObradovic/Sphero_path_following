...
class ReynoldsController(object):
    ...
    def callback(self, *data):
        ...
        if self.params_set:
            ...
            ret_vel, viz = self.agent.compute_velocity(my_agent, nearest_agents, obstacles, self.robot_x, self.robot_y)
    ...
    def param_callback(self, data):
        ...
        param_names = ['alignment_factor', 'cohesion_factor', 'separation_factor', 'avoid_factor',
                       ...
                       'search_radius', 'avoid_radius', 'arrival_factor','arrival_radius']
    ...
    def virtual_robot_callback(self, pose_message):
        self.robot_x=pose_message.pose.pose.position.x
        self.robot_y=pose_message.pose.pose.position.y
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/virtual_robot/odom', Odometry, self.virtual_robot_callback, queue_size=10)
