...
class Boid(object):
    ...
    def update_parameters(self, params):
        ...
        self.arrival_factor=params['arrival_factor']
        ...
        rospy.logdebug('arrival_radius:  %s', self.arrival_radius)
    ...
    def compute_velocity(self, my_agent, nearest_agents, avoids, pose_x1, pose_y1):
        """Compute total velocity based on all components."""
        ...
        # Normal operation, velocity is determined using Reynolds' rules.
            ...
            arrival= self.compute_arrival(pose_x1, pose_y1, my_agent)
            ...
            rospy.logdebug("arrival:        %s", arrival)
            ...
            force += arrival* self.arrival_factor
            ...
            self.viz_components['arrival'] = arrival*self.arrival_factor
