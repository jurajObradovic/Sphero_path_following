...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/virtual_robot/odom", Odometry, callback_virtual)
    rospy.Subscriber("/virtual_robot2/odom", Odometry, callback_virtual2)
    rospy.spin()
